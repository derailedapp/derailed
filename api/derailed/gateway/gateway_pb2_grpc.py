...
class GatewayStub(object):
    ...
    def __init__(self, channel):
        ...
        self.dispatch_channel = channel.unary_unary(
                '/derailed.gateway.Gateway/dispatch_channel',
                request_serializer=gateway__pb2.Interchange.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
...
class GatewayServicer(object):
    ...
    def dispatch_channel(self, request, context):
...
def add_GatewayServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'dispatch_channel': grpc.unary_unary_rpc_method_handler(
                    servicer.dispatch_channel,
                    request_deserializer=gateway__pb2.Interchange.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
    }
    ...
    server.add_registered_method_handlers('derailed.gateway.Gateway', rpc_method_handlers)
